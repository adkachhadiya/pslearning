<html>
<head>
	<script type="text/javascript" src="<?php echo $CFG->wwwroot.'/theme/elearning/javascript/uikit.js' ?>"></script>
	<script type="text/javascript" src="<?php echo $CFG->wwwroot.'/theme/elearning/javascript/uikit.min.js' ?>"></script>	 
</head>
<body>
<!--[if IE]>
