 ...
 */
function elearning_process_css($css, $theme) {

    // Set the background image for the logo
    $logo = $theme->setting_file_url('logo', 'logo');
    $css = elearning_set_logo($css, $logo, $theme);

	// Set the background image for the page.
    $setting = 'pagebackground';
    $pagebackground = $theme->setting_file_url($setting, $setting);
    $css = elearning_set_pagebackground($css, $pagebackground, $setting);
    ...
    $css = elearning_set_upcourseseparatoricon($css, $upcourseseparatoricon, $setting);
    ...
    $css = elearning_set_testimonialseparatoricon($css, $testimonialseparatoricon, $setting);
   ...
   // Set the line image for the Testimonial.
    ...
    $css = elearning_set_testimonialseparatorline($css, $testimonialseparatorline, $setting);
    ...
    $css = elearning_set_testimonialbackground($css, $testimonialbackground, $setting);
    
    // Set the Social Networks icons.
    $setting = 'gmailicon';
    $gmailicon = $theme->setting_file_url($setting, $setting);
    $css = elearning_set_gmailicon($css, $gmailicon, $setting);
    
    $setting = 'facebookicon';
    $facebookicon = $theme->setting_file_url($setting, $setting);
    $css = elearning_set_facebookicon($css, $facebookicon, $setting);
    
    $setting = 'twittericon';
    $twittericon = $theme->setting_file_url($setting, $setting);
    $css = elearning_set_twittericon($css, $twittericon, $setting);
    
    $setting = 'skypeicon';
    $skypeicon = $theme->setting_file_url($setting, $setting);
    $css = elearning_set_twittericon($css, $skypeicon, $setting);
    ...
    $css = elearning_set_customcss($css, $customcss);

    return $css;
}

function elearning_set_logo($css, $logo, $theme) {
    $tag = '[[setting:logo]]';
    $replacement = $logo;
...
function elearning_set_pagebackground($css, $pagebackground, $setting) {
    global $OUTPUT;
...
function elearning_set_upcourseseparatoricon($css, $upcourseseparatoricon, $setting) {
    global $OUTPUT;
...
function elearning_set_testimonialseparatoricon($css, $testimonialseparatoricon, $setting) {
    global $OUTPUT;
...
function elearning_set_testimonialseparatorline($css, $testimonialseparatorline, $setting) {
    global $OUTPUT;
...
function elearning_set_testimonialbackground($css, $testimonialbackground, $setting) {
    global $OUTPUT;
...
function elearning_set_customcss($css, $customcss) {
...
function elearning_set_gmailicon($css, $gmailicon, $setting) {
    global $OUTPUT;
...
function elearning_set_facebookicon($css, $facebookicon, $setting) {
    global $OUTPUT;
...
function elearning_set_twittericon($css, $twittericon, $setting) {
    global $OUTPUT;
...
function elearning_set_skypeicon($css, $skypeicon, $setting) {
    global $OUTPUT;
