...
<head>
   <title><?php echo $PAGE->title ?></title>     
    ...
    <link href="<?php echo $CFG->wwwroot.'/theme/elearning/style/homepage.css' ?>" rel="stylesheet">
    <script type="text/javascript" src="<?php echo $CFG->wwwroot.'/theme/elearning/javascript/jquery.min.js' ?>"></script>	
     <script>
